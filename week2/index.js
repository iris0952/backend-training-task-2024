...
var l = '8';
// 請文字解釋為什麼
console.log(k * l > 21);//使用算術運算子時會觸發JavaScript的隱含轉型，將8轉型為數字8
...
if (performanceData.coaches[1].performance < 50000) {
  performanceData.coaches[1].performance += 50000 - performanceData.coaches[0].performance
}
...
// 練習：計算小明今日消耗的卡路里
calorieBurn += activities.bicycle.caloriesBurnedPerMin*10 + activities.treadmill.caloriesBurnedPerMin*30 + activities.yoga.caloriesBurnedPerMin*40 + activities.bicycle.caloriesBurnedPerMin*10;
