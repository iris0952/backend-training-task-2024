...
const reTrainingOneByOneLessons = 1500;
...
let AlexBudget = campaignBudget - (yogaGroupClass*3 + reTrainingGroupClass + reTrainingOneByOneLessons);
...
const groupClasses = 2;

let machineUsePriceTotal = machineUseTime * machineUsePrice;
let groupClassesTotal = groupClasses * groupClassesPrice;
...
let numberArr2 = numberArr1;// 宣告了一個 numberArr2 的變數，並賦予了 numberArr1 的變數
numberArr2.push(20); // 將 numberArr2 的變數重新賦予了一個 numberArr2 的變數加上 20 的數字型別
numberArr2 = [25, 30, 35];// 將 numberArr2 的變數重新賦予了一個 [25, 30, 35] 的陣列
console.log(numberArr1, numberArr2);// Ans: [5, 10, 15, 20] [25, 30, 35]
